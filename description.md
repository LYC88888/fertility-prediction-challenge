...
First submission - XGBoost + SMOTE + hyperparameter tuning (226 + new_child = 227 variables)
...
Second submission - XGBoost + SMOTE + hyperparameter tuning (298 + new_child = 299 variables)
